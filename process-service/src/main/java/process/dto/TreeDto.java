...
public class TreeDto {
    ...
    public static final String PROCESS_PRIMITIVE_ICON = "glyphicon glyphicon-folder-close";
    public static final String ACTIVITY_ICON = "glyphicon glyphicon-minus-sign";
    private long id;
    ...
    public String toString() {
        return "TreeDto{" + "id=" + id + ", parent=" + parent + ", text=" + text + ", icon=" + icon + ", primitive="
